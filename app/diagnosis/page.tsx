...
export default function DiagnosisPage() {
    ...
    const handleShare = useCallback(
        (platform: 'x' | 'line' | 'copy') => {
            ...
            const shareText = `私にピッタリの副業は「${topResult.service.name}」（おすすめ度${topResult.matchRate}%）でした！\n\n無料副業診断はこちら\n${SITE_CONFIG.url}/diagnosis`;
            if (platform === 'x') {
        ...
        <>
            ...
            <section className="results-section">
                <div className="results-header">
                    <h2>あなたにおすすめの副業 TOP3</h2>
                    <p className="results-subtitle">回答を分析し、あなたに最適な副業を選びました</p>
                </div>
